...
firebase_admin.initialize_app(cred, {"databaseURL": "https://automatedparkingsystem-289d5-default-rtdb.asia-southeast1.firebasedatabase.app/"})
   ...
   for (i,c) in enumerate(countershape):
        ...
        for(x,y) in detect:
            if y<(count_line+offset) and y>(count_line-offset):
                ...
                #update in database
                ref.update({"Total_Vehicles" : counter})
